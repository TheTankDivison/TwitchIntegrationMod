...
--for k, v in pairs(TIM._settings.TwitchRewards["29e35bac-648a-4264-83e3-0d18e70bb186"].effects.tazer or {}) do
			...
			managers.mission._fading_debug_output:script().log(tostring(TIM._settings.TwitchRewards["181d875d-f765-493b-a88e-03aa5b58abfe"].effects.nosound.SoundLevel3.Value),  Color.green)	
